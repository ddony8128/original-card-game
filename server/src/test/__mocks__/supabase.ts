  ...
  const base: Row[] = [
    ...
    },
    {
      ...
      effect_json: {
        ...
        triggers: [
          {
            effects: [{ type: "damage", range: 1, value: 2, target: "near_enemy" }],
            trigger: "onCast",
          },
        ],
      },
    ...
    },
    {
      ...
      effect_json: {
        ...
        triggers: [
          {
            effects: [{ type: "move", value: 1, target: "self", direction: "choose" }],
            trigger: "onCast",
          },
        ],
      },
    ...
    },
    {
      ...
      effect_json: {
        ...
        triggers: [
          {
            effects: [{ type: "damage", range: 2, value: 3, target: "near_enemy" }],
            trigger: "onCast",
          },
        ],
      },
    },
    {
      ...
      effect_json: {
        ...
        triggers: [
          {
            effects: [
              { type: "discard", value: 8, method: "deck_random", target: "enemy" },
        ...
        triggers: [
          {
            effects: [
              ...
              { type: "discard", value: 1, method: "hand_choose", target: "self" },
            ],
            trigger: "onCast",
          },
        ],
    ...
    },
    {
      ...
      effect_json: {
        ...
        triggers: [
          {
            effects: [{ type: "damage", range: 4, value: 2, target: "near_enemy" }],
            trigger: "onCast",
          },
        ],
      },
